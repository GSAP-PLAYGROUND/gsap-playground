      ...
      <dl className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="brutalist-card p-6 bg-white flex flex-col gap-3">
          ...
          <dd className="text-sm font-sans font-medium text-zinc-600 leading-relaxed m-0">
            TweenLabs is a dedicated front-end animation resource library
            featuring production-ready GreenSock (GSAP) components and
            interactive React templates. It provides web developers and UI
            designers with reusable, copy-paste code snippets to build
            high-fidelity scroll animations, creative layouts, and interactive
            web experiences.
          </dd>
        </div>
        ...
        <div className="brutalist-card p-6 bg-white flex flex-col gap-3">
          ...
          <dd className="text-sm font-sans font-medium text-zinc-650 leading-relaxed m-0">
            To optimize GSAP in Next.js App Router, run all timeline
            configurations inside client-side components using the{" "}
            <code>useGSAP</code> hook. Use CSS initial values for layout
            properties to prevent Layout Shifts (CLS), and wrap animations in
            media checks to respect user preferences.
          </dd>
        </div>
        ...
        <div className="brutalist-card p-6 bg-white flex flex-col gap-3">
          ...
          <dd className="text-sm font-sans font-medium text-zinc-650 leading-relaxed m-0">
            Always clean up your animation contexts when React components
            unmount. Using the official <code>@gsap/react</code>{" "}
            <code>useGSAP</code> helper hook automatically performs context
            reversion and cleanup when the component unmounts, preventing memory
            leaks and orphaned timelines.
          </dd>
        </div>
      </dl>
    </section>
