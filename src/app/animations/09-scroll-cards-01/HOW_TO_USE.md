# How to Use: Stacking Cards Scroll

This guide details how to integrate the dynamic **Stacking Cards** pinning and scroll animation using GSAP and ScrollTrigger.
...
import gsap from "use-gsap"; // Or standard gsap import
        ...
        {cards.map((card, index) => (
          ...
          >
            <div
              ...
              style={{
                top: `${index * 44}px`, // Stack offset height layering
            ...
            >
              ...
              <div className="flex-1 flex flex-col gap-3 relative z-10">
                ...
                <p className="font-sans font-medium text-xs md:text-sm leading-relaxed text-zinc-600 mt-2">
                  {card.copy}
                </p>
              </div>
...
1. Create a new component file inside your React/Next.js folder structure, for example:
   `file:///your-project/src/components/StackingCards.tsx`
...
```tsx
import StackingCards from "@/components/StackingCards.tsx";
