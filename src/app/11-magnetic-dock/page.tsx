    ...
    <div className="relative min-h-screen bg-[#f0eadf] text-[#2a2a2a] flex flex-col items-center justify-between p-8 selection:bg-wtf-yellow selection:text-black overflow-hidden" ref={containerRef}>
      ...
      <header className="z-10 w-full max-w-2xl text-center flex flex-col gap-4 mt-8">
        ...
        <p className="max-w-md mx-auto text-zinc-700 text-sm leading-relaxed font-sans font-medium">
          Hover over the bottom dock items to feel the magnetic attraction force. Click any button to trigger a premium squash-and-stretch animation.
        </p>
      </header>
      ...
      <main className="z-10 flex-1 flex items-center justify-center w-full max-w-xl my-12">
        <div className="w-full brutalist-card p-12 bg-white flex flex-col gap-6 text-center justify-center items-center min-h-[200px]">
          <span className="font-mono text-xs text-zinc-400 uppercase tracking-widest">[ Active Destination ]</span>
          ...
          <p className="text-xs font-mono bg-zinc-100 border-2 border-[#2a2a2a] px-4 py-1.5 rounded-md shadow-[2px_2px_0px_#2a2a2a]">
            {activeItem ? `Navigating to active portal: /${activeItem}` : "Hover and click below"}
          </p>
        </div>
      </main>
