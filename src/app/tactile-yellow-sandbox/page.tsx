  ...
  return (
    <div className="relative min-h-screen bg-[#f0eadf] text-[#2a2a2a] flex flex-col items-center justify-center p-4 selection:bg-wtf-yellow selection:text-black">
      ...
      <div className="z-10 w-full max-w-xl brutalist-card p-8 bg-white flex flex-col gap-6 text-center">
        <div className="inline-flex self-center items-center gap-2 bg-wtf-yellow border-2 border-[#2a2a2a] px-4 py-1.5 rounded-full text-[10px] font-mono font-bold text-[#2a2a2a] uppercase tracking-widest shadow-[3px_3px_0px_#2a2a2a] tilt-right">
          <span>Tactile Yellow Sandbox</span>
        </div>
        
        <h1 className="text-4xl font-serif font-black uppercase tracking-tight leading-none">
          Tactile Yellow Sandbox
        </h1>
        
        <p className="text-sm font-sans font-medium text-zinc-700">
          This is your sandbox page for <span className="font-bold">Tactile Yellow Sandbox</span>. Replace this content with your custom layouts and GSAP animations.
        </p>
